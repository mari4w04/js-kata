...
function createLi(alink, adesc){
    let newLi = document.createElement("LI");
    
    
    let newLink = document.createElement("a");
    newLink.href = alink;
    newLink.textContent = adesc;
    newLi.appendChild(newLink);
    return newLi;
}

list_data.forEach(function(el){
    console.log(el.link, el.description);
    
    document.querySelector("#thelist").appendChild(createLi(el.link, el.description));
});
